...
class DecoderNode(object):
    def __init__(self):
        ...
        self.pub_raw = rospy.Publisher("/pi_cam/image_raw",Image,queue_size=1)
        self.last_stamp = rospy.Time.now()
        self.sub_compressed_img = rospy.Subscriber("/pi_cam/image_compressed",CompressedImage,self.cbImg,queue_size=1)
